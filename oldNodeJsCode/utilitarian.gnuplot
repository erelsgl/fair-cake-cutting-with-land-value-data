...
set output sprintf('%s-avg.png',filename)
...
plot \
	filename using xcolumn:5 linecolor rgb "blue" title 'Even-Paz' with points, \
	f2(x) linecolor rgb "blue" lw 2 title '', \
	filename using xcolumn:8 linecolor rgb "red" title 'Assessor' with points, \
	f5(x) linecolor rgb "red" lw 2 title '', \
