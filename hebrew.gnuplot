...
plot \
	filename using xcolumn:4 linecolor rgb "blue" title 'חלוקה הוגנת - מינימום' with points, \
	f1(x) linecolor rgb "blue" lw 2 title '', \
	filename using xcolumn:7 linecolor rgb "blue" title 'חלוקת שמאי - מינימום' with points, \
